...
In the multi-strata model of the real, the discussion that follows deals with physical entities in the inorganic layer. The theories are creations than reside in the objective part of the spiritual layer. There are theories that involve the psychic layer but they will not be considered in this chapter. The psychic layer can only come into play if there is someone there to have perceptions and thoughts.
